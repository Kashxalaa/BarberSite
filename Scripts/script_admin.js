...
function loadBookings() {
    ...
    db.forEach((booking, index) => {
        ...
        row.innerHTML = `
            ...
            <td data-label="Status"><span class="badge ${booking.paid === 'Manual Entry' ? 'badge-manual' : 'badge-deposit'}">${booking.paid}</span></td>
            <td data-label="Action"><button class="btn-delete" onclick="deleteBooking(${index})">Remove</button></td>
        `;
